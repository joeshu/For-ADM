...
(() => {
  ...
  try {
    ...
    if (hitReceipt) {
      ...
      const oti_tx = headers['original-transaction-id'] || headers['Original-Transaction-Id'] || '30003219514509';
      const productId = appConfig.id;
      const transaction = {
        "productId": productId,
        "storefront": "US",
        "transactionId": oti_tx,
        "originalTransactionId": oti_tx,
